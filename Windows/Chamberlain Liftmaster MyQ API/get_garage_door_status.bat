...
SET "json_file=get_devices_and_info_about_myq_system_RESPONSE.json"
...
:: jq-win64.exe file is windows JSON parser file. There are versions for other platfroms: jq-linux64, jq-osx-amd64
