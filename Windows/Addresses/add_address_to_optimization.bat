...
curl -o file1.txt -g -X PUT -k -d "@address_for_optimization.json" "%URL%/api.v4/optimization_problem.php?api_key=%apikey%&optimization_problem_id=%optprobid%&reoptimize=1" 
