...
SET url=https://oa.route4me.com/api/v1/statistics/route/created/count-grouped
...
:: The example refers to the process of getting the statistics of the route creating

ECHO ON

curl -o Statistics_route_created_RESPONSE.json -H "Accept: application/json" -g -k -X GET  "%url%?auth_token=%authToken%&from_ts=%from_ts%&trim_ts=%trim_ts%"
