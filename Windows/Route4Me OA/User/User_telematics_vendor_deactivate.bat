...
curl -o User_telematics_vendor_deactivate_RESPONSE.json -H "Content-Type: application/json" -H "x-auth-token: %xAuthToken%" -H "Accept: application/json" -g -k -X PATCH -d "@User_telematics_vendor_deactivate_data.json" "%url%%user_id%"
